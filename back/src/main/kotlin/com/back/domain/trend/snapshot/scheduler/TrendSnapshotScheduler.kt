...
@Component
class TrendSnapshotScheduler(
    private val trendSnapshotService: TrendSnapshotService
) {
    companion object {
        private val log = LoggerFactory.getLogger(TrendSnapshotScheduler::class.java)
        private val KST: ZoneId = ZoneId.of("Asia/Seoul")
    }

    @Scheduled(cron = "0 5 0 * * *", zone = "Asia/Seoul")
    fun snapshotYesterday() {
