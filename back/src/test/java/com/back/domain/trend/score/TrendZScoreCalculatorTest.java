...
class TrendZScoreCalculatorTest {
    ...
    void clearIncreaseProducesHighPositiveZ() {
        ...
        double z = calculator.calculate(10, 1000, 50, 1000);
    ...
    void decreaseProducesNegativeZ() {
        // 기준일: 10% -> 오늘: 5%
        double z = calculator.calculate(100, 1000, 50, 1000);
    ...
    void brandNewWordStillComputesPositiveZ() {
        ...
        double z = calculator.calculate(0, 1000, 20, 1000);
    ...
    void noOccurrenceAnywhereReturnsZeroNotNaN() {
        double z = calculator.calculate(0, 1000, 0, 1000);
